...
module.exports = {
    ...
    BLOG_CREATE_SUCCESS: "게시글 작성 성공",
    BLOG_CREATE_FAIL: "게시글 작성 실패",
    BLOG_READ_ALL_SUCCESS: "게시글 전체 조회 성공",
    BLOG_READ_ALL_FAIL: "게시글 전체 조회 실패",
    BLOG_READ_SUCCESS: "게시글 조회 성공",
    BLOG_READ_FAIL: "게시글 조회 실패",
    BLOG_UPDATE_SUCCESS: "게시글 수정 성공",
    BLOG_UPDATE_FAIL: "게시글 수정 실패",
    BLOG_DELETE_SUCCESS: "게시글 삭제 성공",
    BLOG_DELETE_FAIL: "게시글 삭제 실패",
